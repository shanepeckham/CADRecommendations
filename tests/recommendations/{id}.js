...
/**
 * Test for /recommendations/{id}
 */
Test('/recommendations/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test recommendations_getById get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/recommendations/{id}']['get']['responses']['200']['schema']);
